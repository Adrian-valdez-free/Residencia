...
<a href="dashboard-admin.php"><i class="fa-solid fa-gauge"></i>Inicio </a>
<a href="Events.php"><i class="fa-solid fa-clipboard-list"></i>Eventos </a>
<a href="Attendance.php"> <i class="fa-solid fa-clipboard-user"></i>Asistencia</a>
<a href="list_users.php"> <i class="fa-solid fa-people-roof"></i></i> Usuarios </a>
